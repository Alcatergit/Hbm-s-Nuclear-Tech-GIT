...
public class LayerNuclearCreeperCharge implements LayerRenderer<EntityNuclearCreeper>
{
    ...
    public LayerNuclearCreeperCharge(RenderNuclearCreeper creeperRendererIn)
    {
        this.creeperRenderer = creeperRendererIn;
    }

    public void doRenderLayer(EntityNuclearCreeper entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
