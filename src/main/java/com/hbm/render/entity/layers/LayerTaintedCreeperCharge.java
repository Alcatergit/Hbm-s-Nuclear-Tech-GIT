...
public class LayerTaintedCreeperCharge implements LayerRenderer<EntityTaintedCreeper>
{
    ...
    public LayerTaintedCreeperCharge(RenderTaintedCreeper creeperRendererIn)
    {
        this.creeperRenderer = creeperRendererIn;
    }

    public void doRenderLayer(EntityTaintedCreeper entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
