	...
	public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
        if(stack.getItemDamage() == 0) {
            ...
            if(!BombConfig.disableNuclear){
                ...
                tooltip.add(" §e"+I18nUtil.resolveKey("desc.radius",(int)(35*(1+BombConfig.falloutRange/100.0)))+"§r");
            }
            ...
            if(!BombConfig.disableNuclear){
                tooltip.add("§a["+ I18nUtil.resolveKey("trait.fallout")+"]"+" §r");
                tooltip.add(" §e"+I18nUtil.resolveKey("desc.radius",(int)(25*(1+BombConfig.falloutRange/100.0)))+"§r");
            }
        }
	}
