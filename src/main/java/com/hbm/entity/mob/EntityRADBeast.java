...
public class EntityRADBeast extends EntityMob implements IRadiationImmune {
    ...
    public void onDeath(DamageSource cause) {
		if (this.isLeader) {
			...
			if(attacker instanceof EntityPlayerMP) {
				AdvancementManager.grantAchievement((EntityPlayerMP)attacker, AdvancementManager.bossMeltdown);
				((EntityPlayerMP)attacker).inventory.addItemStackToInventory(new ItemStack(ModItems.coin_radiation));
			}
		}
		super.onDeath(cause);
	}
    ...
    public void onLivingUpdate() {
        ...
        if (this.isLeader) this.bossInfo.setPercent(this.getHealth() / this.getMaxHealth());
    ...
    public void addTrackingPlayer(EntityPlayerMP player) {
        ...
        if (this.isLeader) this.bossInfo.addPlayer(player);
    }

    @Override
    public void removeTrackingPlayer(EntityPlayerMP player) {
        super.removeTrackingPlayer(player);
        if (this.isLeader) this.bossInfo.removePlayer(player);
    }
